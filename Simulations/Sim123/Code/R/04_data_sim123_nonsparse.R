...
# 04: generate simulation data for non-sparse truth setting
###################################################################
rm(list = ls())
...
###################################################################
# Generate simulation data for setting 1, non-sparse truth
...
save(xmat_list,mmat_list,smat_list,file = "../../Data/sim123_nonsparse_lowSNR.RData")
writeMat("../../Data/sim123_nonsparse_lowSNR.mat",xmat_matlab_lowSNR=xmat_matlab_lowSNR)
...
save(xmat_list,mmat_list,smat_list,file = "../../Data/sim123_nonsparse_mediumSNR.RData")
writeMat("../../Data/sim123_nonsparse_mediumSNR.mat",xmat_matlab_mediumSNR=xmat_matlab_mediumSNR)
...
save(xmat_list,mmat_list,smat_list,file = "../../Data/sim123_nonsparse_highSNR.RData")
writeMat("../../Data/sim123_nonsparse_highSNR.mat",xmat_matlab_highSNR=xmat_matlab_highSNR)
