...
for (i in 1:400) {
  load(paste0("../Data/deconfound_fastICA/AIPWE/AIPWE_ASD_TD_z_stat_",i,".RData"))
...
###################################################################
load("../Data/naive_z_stat_fastICA.RData")
...
pdf("../Figures/AIPWE_vs_naive_fastICA.pdf",width = 10, height = 6)
...
pdf("../Figures/AIPWE_adjusted_fastICA.pdf",width = 7,height = 7)
...
pdf("../Figures/Naive_fastICA.pdf",width = 7,height = 7)
#corrplot(full_cor,method = "color",tl.col="black",is.corr = F)
#corrplot(full_cor,method = "color",tl.col="black",is.corr = F,order = "hclust")
...
save(z_stat,z_drtmle,z_aiptw,z_drtmle_stat_all,z_aiptw_stat_all,file = "../Results/deconfounded_results_fastICA.RData")
...
for (i in 1:400) {
  load(paste0("../Data/deconfound_fastICA/outcome_model/outcome_predict_",i,".RData"))
...
pdf("../Figures/IC18_20_Jitter_fastICA.pdf",width = 4,height = 4)
...
pdf("../Figures/IC5_13_Jitter_fastICA.pdf",width = 4,height = 4)
ggplot(dat_jitter,aes(group,z))+
  geom_jitter(color="#666666",width = 0.2) + 
