...
cd /home/zwan873/Real_Data_Application/Data/deconfound_fastICA
...
submit_mark=1   # counter, count the index of the nodes
        ...
        for a in $(seq 1 400); do   # index for the submitted
                    ...
                    sed -e s:seedID:"${a}":g </home/zwan873/Real_Data_Application/Data/deconfound_fastICA/10_deconfounded_singleseed_fastICA.R >bash_outputs/deconfounded_singleseed_fastICA${a}.R
                    sed -e s:seedID:"${a}":g </home/zwan873/Real_Data_Application/Data/deconfound_fastICA/10_deconfound_singleseed.sh >bash_outputs/deconfound_singleseed_fastICA${a}.sh
                    ...
                    if [ ! -e ./AIPTW/AIPTW_ASD_TD_z_stat_"$a".RData ]; then    # check to see if there is already an output or result
                    ...
                    while [ $submit_mark -gt 0 ]; do
                        ...
                        if [[ $job_num -lt 3 ]] && [[ $submit_mark -eq 1 ]]; then # if the job_num is less than 3 (i.e. $job_num -lt 3), then you can submit jobs to it; if it is larger than 3, you will move on to the next node
                            ...
                            qsub  -R y -N seed${a} -w n -pe smp 1 -cwd -l h=node4.cluster -l mem_free=15G -l h_vmem=15G -j y -o ./bash_outputs/log_"$a" ./bash_outputs/deconfound_singleseed_fastICA${a}.sh
                            submit_mark=2
                        ...
                        if [[ $job_num -lt 3 ]] && [[ $submit_mark -eq 2 ]]; then
                            qsub  -R y -N seed${a} -w n -pe smp 1 -cwd -l h=node5.cluster -l mem_free=10G -l h_vmem=10G -j y -o ./bash_outputs/log_"$a" ./bash_outputs/deconfound_singleseed_fastICA${a}.sh
                            submit_mark=3
                            sleep 15
                            break
                        fi
                        ...
                        if [[ $job_num -lt 3 ]] && [[ $submit_mark -eq 3 ]]; then
                            qsub  -R y -N seed${a} -w n -pe smp 1 -cwd -l h=node6.cluster -l mem_free=10G -l h_vmem=10G -j y -o ./bash_outputs/log_"$a" ./bash_outputs/deconfound_singleseed_fastICA${a}.sh
                            submit_mark=4
                            sleep 15
                            break
                        fi
                        ...
                        if [[ $job_num -lt 2 ]] && [[ $submit_mark -eq 4 ]]; then
                            qsub  -R y -N seed${a} -w n -pe smp 1 -cwd -l h=node8.cluster -l mem_free=10G -l h_vmem=10G -j y -o ./bash_outputs/log_"$a" ./bash_outputs/deconfound_singleseed_fastICA${a}.sh
                            submit_mark=5
                            sleep 15
                            break
                        fi
                        ...
                        if [[ $job_num -lt 3 ]] && [[ $submit_mark -eq 5 ]]; then
                            qsub  -R y -N seed${a} -w n -pe smp 1 -cwd -l h=master2.cluster -l mem_free=10G -l h_vmem=10G -j y -o ./bash_outputs/log_"$a" ./bash_outputs/deconfound_singleseed_fastICA${a}.sh
                            submit_mark=6
                            sleep 15
                            break
                        fi
                        ...
                        if [[ $job_num -lt 3 ]] && [[ $submit_mark -eq 6 ]]; then
                            qsub  -R y -N seed${a} -w n -pe smp 1 -cwd -l h=node15.cluster -l mem_free=10G -l h_vmem=10G -j y -o ./bash_outputs/log_"$a" ./bash_outputs/deconfound_singleseed_fastICA${a}.sh
                            submit_mark=7
                            sleep 15
                            break
                        fi
                        ...
                        if [[ $job_num -lt 2 ]] && [[ $submit_mark -eq 7 ]]; then
                            qsub  -R y -N seed${a} -w n -pe smp 1 -cwd -l h=node16.cluster -l mem_free=10G -l h_vmem=10G -j y -o ./bash_outputs/log_"$a" ./bash_outputs/deconfound_singleseed_fastICA${a}.sh
                            submit_mark=8
                            sleep 15
                            break
                        fi
                        ...
                        if [[ $job_num -lt 2 ]] && [[ $submit_mark -eq 8 ]]; then
                            qsub  -R y -N seed${a} -w n -pe smp 1 -cwd -l h=node17.cluster -l mem_free=10G -l h_vmem=10G -j y -o ./bash_outputs/log_"$a" ./bash_outputs/deconfound_singleseed_fastICA${a}.sh
                            submit_mark=9
                            sleep 15
                            break
                        fi
                        ...
                        if [[ $job_num -lt 2 ]] && [[ $submit_mark -eq 9 ]]; then
                            qsub  -R y -N seed${a} -w n -pe smp 1 -cwd -l h=node18.cluster -l mem_free=10G -l h_vmem=10G -j y -o ./bash_outputs/log_"$a" ./bash_outputs/deconfound_singleseed_fastICA${a}.sh
                            submit_mark=10
                            sleep 15
                            break
                        fi
                        ...
                        if [[ $job_num -lt 2 ]] && [[ $submit_mark -eq 10 ]]; then
                            qsub  -R y -N seed${a} -w n -pe smp 1 -cwd -l h=node19.cluster -l mem_free=10G -l h_vmem=10G -j y -o ./bash_outputs/log_"$a" ./bash_outputs/deconfound_singleseed_fastICA${a}.sh
                            submit_mark=11
                            sleep 15
                            break
                        fi
                        ...
                        if [[ $job_num -lt 3 ]] && [[ $submit_mark -eq 11 ]]; then
                            qsub  -R y -N seed${a} -w n -pe smp 1 -cwd -l h=node20.cluster -l mem_free=10G -l h_vmem=10G -j y -o ./bash_outputs/log_"$a" ./bash_outputs/deconfound_singleseed_fastICA${a}.sh
                            submit_mark=12
                            sleep 15
                            break
                        fi
                        ...
                        if [[ $job_num -lt 2 ]] && [[ $submit_mark -eq 12 ]]; then
                            qsub  -R y -N seed${a} -w n -pe smp 1 -cwd -l h=node21.cluster -l mem_free=10G -l h_vmem=10G -j y -o ./bash_outputs/log_"$a" ./bash_outputs/deconfound_singleseed_fastICA${a}.sh
                            submit_mark=13
                            sleep 15
                            break
                        fi
