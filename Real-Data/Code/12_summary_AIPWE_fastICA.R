...
# 12: summarize AIPWE estimation results and make figures, for fastICA solution
...
###################################################################
load("../Results/naive_z_stat_fastICA.RData")
...
save(z_stat,z_aiptw,z_aiptw_stat_all,file = "../Results/deconfounded_results_fastICA.RData")
