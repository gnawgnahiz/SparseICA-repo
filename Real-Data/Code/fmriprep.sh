...
# user inputs:
# dataset directory
bids_root_dir=/data/ABIDE/ABIDEII-KKI
...
export FS_LICENSE=/data/ABIDE/fmriprep_preprocessed/ABIDEII-KKI/derivatives/license.txt

# run fmriprep
# co-registration, normalization, physilogically component extration
source ~/.bash_profile
fmriprep-docker $bids_root_dir /data/ABIDE/fmriprep_preprocessed/ABIDEII-KKI/derivatives \
  participant \
  --no-tty \
  --participant-label $subj \
  --skip-bids-validation \
  --md-only-boilerplate \
  --fs-license-file /data/ABIDE/fmriprep_preprocessed/ABIDEII-KKI/derivatives/license.txt \
