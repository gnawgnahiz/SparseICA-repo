...
# 09: Estimate mixing matrix for each subject in ABIDEI-NYU, using fastICA solution
...
for (i in 1:dim(my_list)[1]) {
  ...
  save(my_M,file=paste0("/home/zwan873/Real-Data/Data/est_M_fastICA/ABIDEI-NYU/",my_list$SUB_ID[i],"_estM_subPC85.RData"))
